class ApplicationController < ActionController::Base
  ...
  def authorize_request
      begin
        ...
        unless @current_user.user_token.token_created_at >=  30.minutes.ago
          ...
          json_response false,"Invalid Tokens"
          return false
        end
  ...
  def init_permission policy_id
    @current_user_permission = @current_user.user_role.policy_contents.where( "policy_id = ?", policy_id )
    if !@current_user_permission.present?
