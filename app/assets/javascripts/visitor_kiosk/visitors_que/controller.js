(function(){
	...
	angular
		...
		visitorsqueController.$inject=['visitorFactory','$timeout'];

		function visitorsqueController(visitorFactory, $timeout ){
			var visitors_que = this,timer,qrcamera;
